<template>
    <div class="register">
        <div class="w-[90%] mt-5 md:w-1/2 mx-auto flex py-8 flex-col px-10 bg-gray-50 rounded-md">
            ...
            <div class="mb-3 w-full">
                ...
                <input class="outline-none borer-none w-full rounded-md shadow py-3 px-4" type=""
            ...
            <div class="mb-3 w-full flex justify-start mt-3">
                <router-link to="/login"
                    class="bg-indigo-500 inline-block hover:bg-indigo-600 cursor-pointer px-5 py-2 md:px-8 md:py-2 rounded-md text-white">Login</router-link>
            </div>
            <div class="mb-3">
